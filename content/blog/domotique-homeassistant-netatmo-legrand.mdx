...
<figure className="ph"><img src="/gallery/domo-interrupteur.webp" alt="Interrupteur Céliane with Netatmo en cours de pose, câblage apparent" loading="lazy" /><figcaption>Un interrupteur Céliane with Netatmo, en cours de pose. Connecté, mais qui marche même sans box.</figcaption></figure>
...
<figure className="ph"><img src="/gallery/domo-sonnette.webp" alt="Sonnette connectée en cours d'installation" loading="lazy" /><figcaption>La sonnette connectée — branchée dans le même cerveau que le reste.</figcaption></figure>
...
<figure className="ph"><img src="/gallery/domo-thermostat.webp" alt="Thermostat Frisquet mural affichant 20°C" loading="lazy" /><figcaption>Le thermostat Frisquet de la chaudière : efficace, mais pas encore relié au cerveau.</figcaption></figure>
